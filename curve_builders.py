...
from discount_curve import DiscountCurve, OISDeposit, OISSwap
from zero_curve import ZeroCurve, TreasuryBond
from forward_curve import ForwardCurve, IBORDeposit, FRA, IBORSwap
from utils import LogLinearInterpolator, MonotonicCubicInterpolator
...
class ForwardCurveBuilder:
    ...
    def build(self):
        ...
        for i, instrument in enumerate(self.instruments):
            ...
            if hasattr(instrument, 'bootstrap'):
                if isinstance(instrument, (IBORDeposit, FRA)):
                    instrument.bootstrap(curve)
